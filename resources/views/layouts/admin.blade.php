<!DOCTYPE html>
<html class="loading" lang="{{ app()->getLocale() }}" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}">
...
<body class="vertical-layout vertical-menu 2-column menu-expanded fixed-navbar" data-open="click"
    ...
    <script src="{{ asset('assets/admin/js/scripts/extensions/date-time-dropper.js') }}" type="text/javascript">
    </script>
    <!-- END PAGE LEVEL JS-->
    ...
    $(".photo").change(function() { // .image : input field class name
        ...
        if (this.files && this.files[0]) {
            ...
            reader.onload = function(e) {
                $('.photo-preview').attr('src', e.target.result); // .image-preview : img tag class name
            }
